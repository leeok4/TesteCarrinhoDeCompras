...
<body>
   ...
   <div class="page-title">Informacoes do pedido</div>
 
   <div class="customer-info-container">
       <h3>Informacoes do comprador:</h3>
       <ul>
           <li>Nome: ${orderInfo.customerName}</li>
           <li>Email: ${orderInfo.customerEmail}</li>
           <li>Telefone: ${orderInfo.customerPhone}</li>
           <li>Endereco: ${orderInfo.customerAddress}</li>
       </ul>
